...
@Module({
  imports: [
    ...
    DatabaseModule,
    AuthModule, SocietiesModule, StaffModule, ClientsModule, ZonesModule,
    ProductsModule, SuppliersModule, SalesModule, InstallmentsModule,
    PaymentsModule, RouteSheetsModule, ClosuresModule, CashboxModule, NotificationsModule,
  ],
