...
import { RouteSheetsAutomationService } from "./services/route-sheet-automation.service";
import { RouteSheetsCronService } from "./services/route-sheet-cron.service";
...
@Module({
  ...
  providers: [
    ...
    RouteSheetsAutomationService,
    RouteSheetsCronService,

    {
      provide: ROUTE_SHEETS_REPOSITORY,
      useClass: RouteSheetsRepository,
    },

    {
      provide: ROUTE_SHEET_ITEMS_REPOSITORY,
      useClass: RouteSheetItemsRepository,
    },
  ],

  exports: [RouteSheetsService, RouteSheetsAutomationService],
})
