...
export class StaffController {
  ...
  @ApiOperation({
    summary:
      "Buscar empleado por email o DNI para autocompletado de formularios",
    description:
      "Pasa ?email=... o ?dni=... Devuelve los datos del empleado si existe, o 404.",
  })
  @ApiResponse({ status: 200, type: StaffResponseDto })
  ...
  @ApiOperation({
    summary:
      "Registrar nuevo empleado (roles: MANAGER, ADMIN, SELLER, COLLECTOR)",
  })
  ...
  @ApiOperation({
    summary: "Crear nuevo SUPER_ADMIN — exclusivo para superadmin",
  })
  @ApiResponse({ status: 201, type: StaffResponseDto })
  @ApiResponse({ status: 409, description: "Email o DNI ya registrado" })
  createSuperAdmin(
