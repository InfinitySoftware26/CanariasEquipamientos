...
@Module({
  ...
  providers: [
    ...
    {
      provide: SALE_VALIDATIONS_REPOSITORY,
      useClass: SaleValidationsRepository,
    },

    {
      provide: DELIVERY_ATTEMPTS_REPOSITORY,
      useClass: DeliveryAttemptsRepository,
    },

    {
      provide: SALE_HISTORY_REPOSITORY,
      useClass: SaleHistoryRepository,
    },
  ],
