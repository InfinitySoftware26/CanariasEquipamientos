...
export class PaymentsController {
  ...
  findAll(
    ...
    return this.paymentsService.findBySociety(user.societyId, { saleId, clientId, staffId, from, to });
  }
  ...
  @ApiOperation({ summary: 'Registrar un pago (imputación automática opcional a una cuota)' })
  ...
  applyPayment(@Param('id', ParseUUIDPipe) id: string, @Body() dto: ApplyPaymentDto) {
